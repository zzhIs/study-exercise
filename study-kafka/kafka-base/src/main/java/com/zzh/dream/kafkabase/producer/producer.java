package com.zzh.dream.kafkabase.producer;
...
public class producer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //将发送的消息包装成ProducerRecord
        ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>(TOPIC_NAME, UUID.randomUUID().toString(), "我是发送的消息...");
        //同步发送消息
