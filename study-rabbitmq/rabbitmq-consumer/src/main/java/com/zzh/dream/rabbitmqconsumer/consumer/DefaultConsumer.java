 ...
 **/
@Component
@RabbitListener(queues = MessageQueueConstant.DEFAULT_DIRECT_QUEUE)
public class DefaultConsumer extends AbstractMqConsumer {

    @Override
    protected Object process(MessageQueueDTO dto) {
        //todo 执行消费者逻辑
        System.out.println("消费完成"+ JSONUtil.toJsonStr(dto.getMessage()));
        return "message";
    }
}
